...
<body>
    ...
    <header>
        <img src="{{ asset('asset/Remaja/thumbnail-dasboard-remaja.png') }}" alt="...">
    </header>
    ...
    <nav>
        <ul class="nav nav-underline justify-content-center">
            <li class="nav-item">
                <a class="nav-link @yield('dashboard')" href="{{ route('remaja') }}">Dashboard</a>
            </li>
            <li class="nav-item">
                <a class="nav-link @yield('kegiatan')" href="{{ route('remaja-kegiatan') }}">Kegiatan</a>
            </li>
            <li class="nav-item">
                <a class="nav-link @yield('galery')" href="{{ route('remaja-galery') }}">Galery</a>
            </li>
            <li class="nav-item">
                <a class="nav-link @yield('pengurus')" href="{{ route('remaja-pengurus') }}">Pengurus</a>
            </li>
            <li class="nav-item">
                <a class="nav-link @yield('tentang')" href="{{ route('remaja-tentang') }}">Tentang</a>
            </li>
        </ul>
    </nav>
